...
"""),_display_(/*3.2*/main(Messages("activate.account.title"))/*3.42*/ {_display_(Seq[Any](format.raw/*3.44*/("""
...
object activateAccount extends activateAccount_Scope0.activateAccount
              /*
                  ...
                  SOURCE: /home/myeong/workspace/Ampoule/server/app/views/activateAccount.scala.html
