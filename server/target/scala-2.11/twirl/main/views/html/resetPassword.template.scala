...
"""),format.raw/*4.1*/("""
"""),_display_(/*5.2*/main(Messages("reset.password.title"))/*5.40*/ {_display_(Seq[Any](format.raw/*5.42*/("""
    """),format.raw/*6.5*/("""<fieldset class="col-md-6 col-md-offset-3">
        ...
        """),_display_(/*8.10*/helper/*8.16*/.form(action = routes.ResetPasswordController.submit(token), 'autocomplete -> "off")/*8.100*/ {_display_(Seq[Any](format.raw/*8.102*/("""
...
object resetPassword extends resetPassword_Scope0.resetPassword
              /*
                  ...
                  SOURCE: /home/myeong/workspace/Ampoule/server/app/views/resetPassword.scala.html
