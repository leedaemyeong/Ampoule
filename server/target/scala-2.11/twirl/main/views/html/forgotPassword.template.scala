...
"""),format.raw/*4.1*/("""
"""),_display_(/*5.2*/main(Messages("forgot.password.title"))/*5.41*/ {_display_(Seq[Any](format.raw/*5.43*/("""
    """),format.raw/*6.5*/("""<fieldset class="col-md-6 col-md-offset-3">
        ...
        """),_display_(/*8.10*/helper/*8.16*/.form(action = routes.ForgotPasswordController.submit(), 'autocomplete -> "off")/*8.96*/ {_display_(Seq[Any](format.raw/*8.98*/("""
...
object forgotPassword extends forgotPassword_Scope0.forgotPassword
              /*
                  ...
                  SOURCE: /home/myeong/workspace/Ampoule/server/app/views/forgotPassword.scala.html
