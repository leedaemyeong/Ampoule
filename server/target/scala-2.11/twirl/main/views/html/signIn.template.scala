...
"""),_display_(/*6.2*/main(Messages("sign.in.title"))/*6.33*/ {_display_(Seq[Any](format.raw/*6.35*/("""
    """),format.raw/*7.5*/("""<fieldset class="col-md-6 col-md-offset-3">
        ...
        """),_display_(/*9.10*/helper/*9.16*/.form(action = routes.SignInController.submit())/*9.64*/ {_display_(Seq[Any](format.raw/*9.66*/("""
        ...
        """),_display_(/*25.10*/if(socialProviders.providers.nonEmpty)/*25.48*/ {_display_(Seq[Any](format.raw/*25.50*/("""
            """),format.raw/*26.13*/("""<div class="social-providers">
                <p>"""),_display_(/*27.21*/Messages("or.use.social")),format.raw/*27.46*/("""</p>
                <div>
                """),_display_(/*29.18*/for(p <- socialProviders.providers if p.id != "clef") yield /*29.71*/ {_display_(Seq[Any](format.raw/*29.73*/("""
                ...
                """),_display_(/*33.18*/defining(socialProviders.get[ClefProvider])/*33.61*/ { clef =>_display_(Seq[Any](format.raw/*33.71*/("""
                    """),_display_(/*34.22*/if(clef.isDefined)/*34.40*/ {_display_(Seq[Any](format.raw/*34.42*/("""
...
object signIn extends signIn_Scope0.signIn
              /*
                  -- GENERATED --
                  DATE: Thu Dec 08 06:59:31 KST 2016
                  SOURCE: /home/myeong/workspace/Ampoule/server/app/views/signIn.scala.html
