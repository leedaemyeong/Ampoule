...
"""),_display_(/*5.2*/main(Messages("sign.up.title"))/*5.33*/ {_display_(Seq[Any](format.raw/*5.35*/("""
    """),format.raw/*6.5*/("""<fieldset class="col-md-6 col-md-offset-3">
        ...
        """),_display_(/*8.10*/helper/*8.16*/.form(action = routes.SignUpController.submit())/*8.64*/ {_display_(Seq[Any](format.raw/*8.66*/("""
...
object signUp extends signUp_Scope0.signUp
              /*
                  ...
                  SOURCE: /home/myeong/workspace/Ampoule/server/app/views/signUp.scala.html
