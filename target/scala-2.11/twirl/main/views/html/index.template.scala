...
"""),_display_(/*3.2*/main("tBOB for your beautiful life", "index")/*3.47*/ {_display_(Seq[Any](format.raw/*3.49*/("""

	"""),format.raw/*5.2*/("""<link rel="stylesheet" media="screen" href=""""),_display_(/*5.47*/routes/*5.53*/.Assets.versioned("stylesheets/carousel.css")),format.raw/*5.98*/("""">
